...
for UTIL in {10..1}; do
    ...
    python3 src/measure_activity_factor.py -u $USER -H $HOST -p $PORT \
        -P 1 -t 1800 -i 0.25 -o result/20240302_steady_temperature/mobilenet_v2_$UTIL_VALUE \
    ...
    python3 src/measure_activity_factor.py -u $USER -H $HOST -p $PORT \
        -P 1 -t 1800 -i 0.25 -o result/20240302_steady_temperature/efficientnet_l_$UTIL_VALUE \
    ...
    python3 src/measure_activity_factor.py -u $USER -H $HOST -p $PORT \
        -P 1 -t 1800 -i 0.25 -o result/20240302_steady_temperature/ssd_mobilenet_v2_$UTIL_VALUE \
